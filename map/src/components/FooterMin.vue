    ...
    <footer v-if="isShown" class="bg-gray-100 py-5 mt-5 border-2 border-gray-300 rounded-lg">
        <div class="max-w-7xl mx-auto px-4 overflow-hidden">
            ...
            <div class="mt-3 flex justify-center space-x-6">
                ...
                <a href="https://www.instagram.com/marcfalzon/" target="_blank" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://twitter.com/MarcFalzon" target="_blank" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://github.com/modenero/use-cash-map" target="_blank" class="text-gray-400 hover:text-gray-500">
