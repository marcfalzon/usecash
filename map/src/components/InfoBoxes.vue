        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">
                    1,348 Total Listings!
                </h2>

                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    Find merchants that accept Bitcoin and other cryptos!
                </p>
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">100% Verified Merchants</p>
                        </dt>
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Are You A Merchant?</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
