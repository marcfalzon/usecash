                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            NOTE: In order to add a merchant to Use.cash, you MUST be within 1 mile of the location.
                        </p>
                    </div>
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <form class="space-y-6" action="javascript://" method="POST">
                            ...
                            <!-- <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="you@example.com"></textarea>
                                </div>
